...
void codegen(AstNode* ast, const char* file, StringTable* strtab, TypeTable* types) {
    ...
    cg.out = fopen(file, "w");
    fprintf(cg.out, "; CHRONOS v0.9 - Pointers Support\n\n");
...
int main(int argc, char** argv) {
    ...
    printf("🔥 CHRONOS v0.9 - POINTERS\n");
    printf("Pointer types + address-of (&) + dereference (*) + arrow (->) enabled\n");
    printf("Compiling: %s\n", argv[1]);
