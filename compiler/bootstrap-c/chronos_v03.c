...
void gen_func(Codegen* cg, AstNode* n) {
    ...
    // New symbol table for this function
...
void codegen(AstNode* ast, const char* file) {
    ...
    emit(&cg, "; CHRONOS v0.3 - PRODUCTION PUSH\n");
    emit(&cg, "; Variables + Parameters + Recursion\n\n");
...
int main(int argc, char** argv) {
    ...
    printf("🔥 CHRONOS v0.3 - PRODUCTION PUSH\n");
    printf("Variables + Recursion enabled\n");
    printf("Compiling: %s\n", argv[1]);
